              ...
              return ListView(
                children: <Widget>[
                  ...
                  ListTile(
                    ...
                    subtitle: Text('${model.nextLaunch.details}',
                  ...
                  ListTile(
                    ...
                    subtitle: Text('It will launch at ${model.nextLaunch.launchDateUtc}',
                        style: textStyle.normalFont),
                    dense: true,
                    trailing: Icon(Icons.keyboard_arrow_right),
                  ),
                  ListTile(
                    ...
                    subtitle: Text('${model.nextLaunch.launchSite.siteNameLong}',
                        style: textStyle.normalFont),
                    dense: true,
                    trailing: Icon(Icons.keyboard_arrow_right),
                  ),
                  ...
                  ListTile(
                    title:
                    Text('Flight Number', style: textStyle.subHeaderStyle),
                    subtitle: Text('${model.nextLaunch.flightNumber}',
                        style: textStyle.normalFont),
                    dense: true,
                  ),
                  ListTile(
                    ...
                    subtitle: Text('Type ${model.nextLaunch.rocket.firstStage.cores[0].landingType} with vehicle ${model.nextLaunch.rocket.firstStage.cores[0].landingVehicle}',
                        style: textStyle.normalFont),
                    dense: true,
                    trailing: Icon(Icons.keyboard_arrow_right),
                  ),
